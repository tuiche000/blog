    ...
    <div id="sidebar-scroll">
        ...
        <div class="sidebar-content">
            ...
            <div class="side-content side-content-full">
                <ul class="nav-main">
                    <li>
                        <a href="../"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">网站首页</span></a>
                    </li>
                    <?php
            ...
            <li><a href=\"templates/register.php\"><i class=\"si si-speedometer\"></i>注册</a></li>";
                    ...
                    ?>
                    <li>
                        <a href="../templates/contacts.php"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">博友</span></a>
                    </li>
                    <li>
                        <a href=""><i class="si si-speedometer"></i><span class="sidebar-mini-hide">相册</span></a>
                    </li>
                    <li>
                        <a href=""><i class="si si-speedometer"></i><span class="sidebar-mini-hide">风格</span></a>
                    </li>

                    <li class="nav-main-heading"><span class="sidebar-mini-hide">友情链接</span></li>
                    <li>
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-note"></i><span class="sidebar-mini-hide">我们的蜜月</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                        </ul>-->
<!--                    </li>-->
<!--                    <li class="nav-main-heading"><span class="sidebar-mini-hide">设置</span></li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-wrench"></i><span class="sidebar-mini-hide">我们的博客</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-magic-wand"></i><span class="sidebar-mini-hide">联系我们</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">测试</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
<!--                                <a href="#">Link 1-1</a>-->
<!--                            </li>-->
...
<!--                        </ul>-->
<!--                    </li>-->
<!--                    <li class="nav-main-heading"><span class="sidebar-mini-hide">测试100</span></li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span class="sidebar-mini-hide">111</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-lock"></i><span class="sidebar-mini-hide">123</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-fire"></i><span class="sidebar-mini-hide">123</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
...
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span class="sidebar-mini-hide">测试2</span></a>-->
<!--                        <ul>-->
<!--                            <li>-->
